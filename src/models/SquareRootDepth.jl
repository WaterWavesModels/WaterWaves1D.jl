...
the "√D" model proposed by [Cotter, Holm and Percival](https://dx.doi.org/10.1098/rspa.2010.0124)
...
1. a function `SquareRootDepth.f!` to be called in the time-integration solver;
