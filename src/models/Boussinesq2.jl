export Boussinesq2,mapto,mapfro
...
"""
mutable struct Boussinesq2 <: AbstractModel
    ...
    function Boussinesq2(param::NamedTuple)
...
function (m::Boussinesq2)(U::Array{Complex{Float64},2})
...
"""
    mapto(Boussinesq2, data)

"""
function mapto(m::Boussinesq2, data::InitialData)
...
"""
    mapfro(Boussinesq2, data)

"""
function mapfro(m::Boussinesq2,
